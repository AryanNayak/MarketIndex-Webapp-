...
function SignUp() {
  ...
  const signUpButton = clsx(classes.signUp, classes.submit);
  return (
    <Container component="main" maxWidth="xs">
      ...
      <div className={classes.paper}>
        ...
        <div className={classes.titleText}>
          <Typography className="mt-20" style={{fontSize:"18px",lineHeight:"21px"}}>
            ...
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <FormControlLabel
                  ...
                  label="I agree to the terms and conditons of the platform."
                />
              </Grid>
            </Grid>
